...
class DeyeDeviceCoordinator(DataUpdateCoordinator[DeviceData]):
    ...
    def _parse_device_data(self, raw: dict[str, Any]) -> DeviceData:
        ...
        return DeviceData(
            ...
            # Battery
            battery_soc_pct=_opt_val("SOC"),
            battery_power_w=_opt_val("BatteryPower"),
            battery_voltage_v=_opt_val("BatteryVoltage"),
            battery_current_a=_opt_val("BatteryCurrent"),
            battery_temperature_c=_opt_val("Temperature- Battery"),
            battery_daily_charge_kwh=_opt_val("DailyChargingEnergy"),
            battery_daily_discharge_kwh=_opt_val("DailyDischargingEnergy"),
            battery_total_charge_kwh=_opt_val("TotalChargeEnergy"),
            battery_total_discharge_kwh=_opt_val("TotalDischargeEnergy"),
            # Grid
            grid_import_power_w=max(0.0, _val("TotalGridPower")),
